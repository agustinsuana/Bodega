    ...
    <body>
        ...
        <div id="height-wrapper">
            ...
            <div role="main" class="container_12" id="content-wrapper">
                <div id="main_content">
                    <h2 class="grid_12"><a href="inicio">Inicio</a>&nbsp;>><a href="listadoClientes">&nbsp;Clientes</a>&nbsp;>><a href="nuevoCliente">&nbsp;Nuevo</a></h2>
                    <div class="clear"></div>
                    ...
                    <div class="grid_5">
                        <div class="box">
                            ...
                            <div class="content">
                                ...
                                <s:form action="registrarCliente" method="post">
                                    <s:textfield label="DNI/RUC" name="cliente.dniruc" size="11"></s:textfield>
                                    <s:textfield label="NOMBRES" name="cliente.nombres" size="50"></s:textfield>
                                    <s:textfield label="APELLIDOS" name="cliente.apellidos" size="50"></s:textfield>
                                    <s:textfield label="DIRECCION" name="cliente.direccion" size="100"></s:textfield>
                                    <s:textfield label="TELEFONO" name="cliente.telefono" size="20"></s:textfield>
                                    <s:textfield label="CELULAR" name="cliente.celular" size="20"></s:textfield>
                                    <s:textfield label="EMAIL" name="cliente.email" size="50"></s:textfield>
