<%-- 
    ...
    Created on : 04-jul-2012, 20:32:56
    ...
    <body>
        ...
        <div id="height-wrapper">
            ...
            <div role="main" class="container_12" id="content-wrapper">
                <div id="main_content">
                    <h2 class="grid_12"><a href="nuevoProveedor">Nuevo Proveedor</a></h2>
                    <div class="clear"></div>
                    ...
                    <div class="grid_12">
                        <div class="box">
                            <div class="header">
                                ...
                                <h3>Listado de Proveedores</h3><span></span>
                            </div>
                            <div class="content">
                                <table id="table-example" class="table">
                                    ...
                                    <s:iterator value="listaProveedor">
                                        <tr class="gradeC">
                                            <td><s:property value="id"></s:property></td>
                                            <td><s:property value="ruc"></s:property></td>
                                            <td><s:property value="razonSocial"></s:property></td>
                                            <td><s:property value="nombreComercial"></s:property></td>
                                            <td><s:property value="representante"></s:property></td>
                                            <td><s:property value="cargo"></s:property></td>
                                            <td><s:property value="direccion"></s:property></td>
                                            <td><s:property value="telefono"></s:property></td>
                                            <td><s:property value="celular"></s:property></td>
                                            <td><s:property value="email"></s:property></td>
                                                <td>
                                                <s:url id="editarURL" action="editarProveedor">
                                                    <s:param name="id" value="%{id}"></s:param>
                                                </s:url>
                                                <s:a href="%{editarURL}"><img src="img/pencil.png" title="Editar"></s:a>
                                                <s:url id="eliminarURL" action="eliminarProveedor">
                                                    <s:param name="id" value="%{id}"></s:param>
                                                </s:url>
                                                <s:a href="%{eliminarURL}"><img src="img/minus-circle.png" title="Eliminar"></s:a>
                                                </td>
                                            </tr>
                                    </s:iterator>
                                </table>
