    ...
    <body>
        ...
        <div id="height-wrapper">
            ...
            <div role="main" class="container_12" id="content-wrapper">
                <div id="main_content">
                    <h2 class="grid_12"><a href="nuevaCategoria">Nueva Categoria</a></h2>
                    <div class="clear"></div>
                    ...
                    <div class="grid_12">
                        <div class="box">
                            <div class="header">
                                ...
                                <h3>Listado de Categorias de Productos</h3><span></span>
                            </div>
                            <div class="content">
                                <table id="table-example" class="table">
                                    ...
                                    <s:iterator value="listaCategoria">
                                        ...
                                        <td>
                                        <s:url id="editarURL" action="editarCategoria">
                                            <s:param name="id" value="%{id}"></s:param>
                                        </s:url>
                                            <s:a href="%{editarURL}"><img src="img/pencil.png" title="Editar"></s:a>
                                        <s:url id="eliminarURL" action="eliminarCategoria">
                                            <s:param name="id" value="%{id}"></s:param>
                                        </s:url>
