    ...
    <body>
        ...
        <div id="height-wrapper">
            ...
            <div role="main" class="container_12" id="content-wrapper">
                <div id="main_content">
                    <h2 class="grid_12"><a href="inicio">Inicio</a>&nbsp;>><a href="listadoProveedores">&nbsp;Proveedores</a>&nbsp;>><a href="nuevoCliente">&nbsp;Editar</a></h2>
                    <div class="clear"></div>
                    ...
                    <div class="grid_5">
                        <div class="box">
                            ...
                            <div class="content">
                                <s:form action="actualizarProveedor" method="post">
                                    <s:textfield label="CODIGO" name="proveedor.id"></s:textfield>
                                    <s:textfield label="RUC" name="proveedor.ruc" size="11"></s:textfield>
                                    <s:textfield label="RAZON SOCIAL" name="proveedor.razonSocial" size="50"></s:textfield>
                                    <s:textfield label="NOMBRE COMERCIAL" name="proveedor.nombreComercial" size="50"></s:textfield>
                                    <s:textfield label="REPRESENTANTE" name="proveedor.representante" size="100"></s:textfield>
                                    <s:textfield label="CARGO" name="proveedor.cargo" size="20"></s:textfield>
                                    <s:textfield label="DIRECCION" name="proveedor.direccion" size="20"></s:textfield>
                                    <s:textfield label="TELEFONO" name="proveedor.telefono" size="50"></s:textfield>
                                    <s:textfield label="CELULAR" name="proveedor.celular" size="50"></s:textfield>
                                    <s:textfield label="EMAIL" name="proveedor.email" size="50"></s:textfield>
