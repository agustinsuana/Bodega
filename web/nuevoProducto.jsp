...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <style type="text/css">
            #registrarProducto_categoria_id{
                visibility: hidden;
            }
        </style>
    </head>
    <body>
        ...
        <div id="height-wrapper">
            ...
            <div role="main" class="container_12" id="content-wrapper">
                <div id="main_content">
                    <h2 class="grid_12"><a href="inicio">Inicio</a>&nbsp;>><a href="listadoProductos">&nbsp;Productos</a>&nbsp;>><a href="nuevoProducto">&nbsp;Nuevo</a></h2>
                    <div class="clear"></div>
                    ...
                    <div class="grid_5">
                        <div class="box">
                            ...
                            <div class="content">
                                ...
                                <br /><br />
                                <s:form action="registrarProducto" method="post">
                                    <s:combobox label="CATEGORIA" headerKey="-1" 
                                                headerValue="Selecciones una categoria" 
                                                list="listaCategoria"  name="categoria.id" 
                                                listValue="nombre" listKey="id" />
                                    <s:textfield label="DESCRIPCION" name="producto.descripcion" size="50"></s:textfield>
                                    <s:textfield label="PRECIO" name="producto.precio" size="10"></s:textfield>
                                    <s:textfield label="CANTIDAD" name="producto.cantidad" size="10"></s:textfield>
                                    <s:textfield label="U. MEDIDA" name="producto.umedida" size="30"></s:textfield>
