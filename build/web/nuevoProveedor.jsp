    ...
    <body>
        ...
        <div id="height-wrapper">
            ...
            <div role="main" class="container_12" id="content-wrapper">
                <div id="main_content">
                    <h2 class="grid_12"><a href="inicio">Inicio</a>&nbsp;>><a href="listadoProveedores">&nbsp;Proveedores</a>&nbsp;>><a href="nuevoCliente">&nbsp;Nuevo</a></h2>
                    <div class="clear"></div>
                    ...
                    <div class="grid_5">
                        <div class="box">
                            ...
                            <div class="content">
                                <!-- Acciones del evento click para registrar -->
                                <s:form action="registrarProveedor" method="post">
