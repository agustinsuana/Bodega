                        ...
                        <div class="box">
                            ...
                            <div class="content">
                                <s:form action="actualizarCliente" method="post">
                                    <s:textfield label="CODIGO" name="cliente.id"></s:textfield>
                                    <s:textfield label="DNI/RUC" name="cliente.dniruc"></s:textfield>
                                    <s:textfield label="NOMBRE" name="cliente.nombres"></s:textfield>
                                    <s:textfield label="APELLIDOS" name="cliente.apellidos"></s:textfield>
                                    <s:textfield label="DIRECCION" name="cliente.direccion"></s:textfield>
                                    <s:textfield label="TELEFONO" name="cliente.telefono"></s:textfield>
                                    <s:textfield label="CELULAR" name="cliente.celular"></s:textfield>
                                    <s:textfield label="EMAIL" name="cliente.email"></s:textfield>
